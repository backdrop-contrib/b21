...
<?php if ($logo): ?>
	<div class="header-logo-wrapper">
	  <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" class="header-logo-link" rel="home"><img src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" class="header-logo" <?php print backdrop_attributes($logo_attributes); ?> /></a>
	</div>
<?php endif; ?>

<?php if ($site_name): ?>
	<div class="header-site-name-wrapper">
    <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" class="header-site-name-link" rel="home"><?php print $site_name; ?></a>
